...
- work: "하는 일" 섹션. Q1을 바탕으로 무슨 일을, 어떻게 하는지 1~2문장. 80자 이내(명함은 가볍게, 핵심만).
- help: "이런 분을 돕습니다" 섹션. Q2를 바탕으로 어떤 상황의 어떤 사람에게 무엇이 도움이 되는지 1~2문장. 80자 이내.
- referral: "이런 분을 소개해주세요" 섹션. Q3를 바탕으로 받는 사람이 주변의 구체적인 한 사람을 떠올릴 수 있게 상황·조건을 짚어서 1문장, 60자 이내.
